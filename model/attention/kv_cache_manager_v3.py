...
class ContextManager:
    def __init__(self, 
        ...
        self.max_retrive_block = topk # maximum number of blocks to retrive
    ...
    def get_indices(self, logits):
        ...
        for u in range(self.num_units):
            ...
            for i, logit in enumerate(sorted_logits):
                ...
                if i >= self.max_retrive_block-1 or accumulated_sum >= self.retrive_threshold:
                    break
    ...
    def _calc_block_topk(
        ...
        logits = None
        # #prefix_retrival -> layeri_num_retrive
        # if self.num_global_block <=100000:
        #     #one-stage
        # else:
        #     #two-stage
        ...
        if self.num_global_block <= self.max_retrive_block:
            ...
            if self.num_global_chunk <= self.max_retrive_block // min_chunk_size + 1: #最末尾的chunk可能会长度小于8
                ...
                # ret = logits.topk(self.max_retrive_block, dim=1).indices #(batch_size, topk) 
                # #print(f'ret:{ret}')
                ...
                #print(f'chunk_logits:{chunk_logits}')
